...
import './DropDown.css';
export function DropDown({title="Select",className,children,getValue}){
...
export function DropDownItem({title,value}){
    return (
        <div data-value={value} className="dropDownItem">
            <p data-value={value}>{title}</p>
        </div>
    )
}