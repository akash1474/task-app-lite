...
export default function TaskContainer() {
  ...
  const tasks = userSettings.showCompleted
    ? taskInfo
    : taskInfo.filter((task: TaskInterface) => !task.isCompleted);
  const imageStyle = {
      ...
      {taskInfo.length > 0 ? (
        ...
        <div className="taskContainer">
          <div className="taskContainer__empty">
            ...
            <p className="taskContainer__suggestion">
              Let's get started with some new one! <br />
              Never GiveUp!!!
            </p>
          </div>
        </div>
